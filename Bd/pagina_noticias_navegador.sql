...
CREATE TABLE `navegador` (
  `idNavegador` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `navegador` VALUES (1,'Inicio ',NULL),(2,'Ultimas Noticias',NULL),(3,'Nosotros',NULL),(4,'Servicios',NULL),(5,'Contacto',NULL);
